...
def generate_class_def_(nom_classe: str, attributs: dict, nom_superclasse: str, args_superclasse: list = []) -> str:
...
# Concaténer la définition de la classe à la chaîne de caractères class_defs
        class_defs+= generate_class_def_(class_name,class_attrs,superclass_name, superclass_args)
