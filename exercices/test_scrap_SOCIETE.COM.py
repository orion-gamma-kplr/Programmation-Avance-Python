...
url="https://www.societe.com/cgi-bin/"
url_search=url+"search?champs=entreprise+"

def main():

# Première consultation du site
        print(url_search.replace('entreprise','SASU+3+S+TELCOM'))
        reponse = requests.get(url_search.replace('entreprise','SASU+3+S+TELCOM'))
